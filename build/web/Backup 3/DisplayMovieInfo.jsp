...
<html>
    ...
    <div class="container">
	  ...
	  <ul class="nav nav-tabs">
        ...
        <form id='DisplayMovieInfo' action="DisplayMovieInfo" method="post" >
            ...
            <%
                ...
                if(rs.next()){ 
                    ...
                    displayBuf1.append("<br><dt style='font-size:20px;'>Duration &nbsp </dt><dd style='font-size:20px;'>" + rs.getInt("duration")+"</dd>");
        ...
        <div class="container">
	  <ul class="nav nav-tabs">
	    <li style="font-size:150%"><a href="DisplayMovies.jsp">Reviews</a></li>
            </ul>
