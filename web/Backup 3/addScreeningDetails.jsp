...
<html>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	  ...
	  <ul class="nav nav-tabs">
        ...
        <div class="container">
            <div class="form">
                <form action="Screening" method="post" class="form-horizontal">                                                
                    <%
                        ...
                        displayBuf.append("<input type='submit' class='btn btn-info'  name='hidoperation' id='hidoperation' value='Submit'/>");
