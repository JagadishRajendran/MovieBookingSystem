      ...
      <div class="container">
        <div class="navbar-header">
          <%  
                ...
                displayBuf1.append("<a class=\"navbar-brand text-right\" href=\"Logout\">Logout</a>");
                displayBuf1.append("<a class=\"navbar-brand text-right\" href=\"DisplayReservedMovie.jsp\">Booked tickets</a>");
