                ...
                <table id="table-control" class="table table-bordered">                                
                        ...
                        <%
                            ...
                            while(rs.next()){
                                ...
                                displayBuf.append("<td>"+"<a id=\"myLink\" href=\"/MovieBookingSystem/DeleteMovieScreening?movieid="+rs.getString("movie_id")+"&screening_id="+rs.getString("screening_id")+"\" onclick=\"return myFunction();\">Delete</a>"+"</td></tr>");
                                //displayBuf.append("<td>"+"<a id=\"myLink\" href=\"#\" onclick=\"myFunction();\">Delete</a>"+"</td></tr>");
