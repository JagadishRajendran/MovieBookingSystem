    ...
    <form id="reservation" action='ShowSeats' method="post" action=".jsp">
      <section id="seats">
        <%
            ...
            if(hmap.containsKey("A 1") && (hmap.get("A 1")==1 || hmap.get("A 1")==2)){ 
                
                displayBuf2.append("<li><input id='A 1' class=\"seat-select-block\" disabled  type='checkbox' value='A 1' name='seat[]' />");
            }
            else{
                displayBuf2.append("<li><input id='A 1' class=\"seat-select\" onclick='selectseat(\"A 1\")' type='checkbox' value='A 1' name='seat[]' />");
            }
